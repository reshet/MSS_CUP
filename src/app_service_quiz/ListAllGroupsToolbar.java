...
public class ListAllGroupsToolbar extends JPanel {
	/**
	 * 
	 */
	...
	public ListAllGroupsToolbar(ServerDispatcher disp,JList lst)
	{
		...
		addBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ListAllGroupsToolbar.this.dispatcher.add(param);
				refreshBtn.doClick();
			}
		});
		delBtn.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				DefaultListModel model = (DefaultListModel) ListAllGroupsToolbar.this.list.getModel();
				int index = list.getSelectedIndex();
				if (index == -1) return;
				int ID = ((ListGroupsElementData)model.getElementAt(index)).getID();
				Integer [] param  = new Integer[1];
				param[0] = ID;
				ListAllGroupsToolbar.this.dispatcher.delete(param);
				refreshBtn.doClick();
			}
		});
		refreshBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ListAllGroupsToolbar.this.dispatcher.refreshHeirGroups(params);
				DefaultListModel model = (DefaultListModel) ListAllGroupsToolbar.this.list.getModel();
