...
public class SProject_Creator_Mgr extends JPanel{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7087902746322489738L;
	...
	public SProject_Creator_Mgr() {
		...
		ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				SProject_Creator_Mgr.this.setDone(true);
			}
		});
