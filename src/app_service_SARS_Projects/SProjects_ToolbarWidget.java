...
public class SProjects_ToolbarWidget extends JPanel {
	/**
	 * 
	 */
...
/*	private ServerDispatcher dispatcher;
	...
	private JButton addBtn,delBtn,refreshBtn;
	private SProject_InstrumentDesk desk;
	private JPanel toolBtns;
	private JLabel infoLbl;
	public SProject_InstrumentDesk getDesk() {
		return desk;
	}
	public void setDesk(SProject_InstrumentDesk desk) {
		this.desk = desk;
		this.add(new JScrollPane(desk.getprj_list()),BorderLayout.CENTER);
		this.desk.refresh_PList();
	}
	private JTextField editor;
	public SProjects_ToolbarWidget(SProject_InstrumentDesk desk)
	{
		this.desk = desk;
		...
		*/
		...
		refreshBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				SProjects_ToolbarWidget.this.desk.refresh_PList();
			}
		});
		/*
