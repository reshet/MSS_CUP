...
public class SPrj_ListElement_Widget extends JPanel implements ListCellRenderer{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	//private ImageComponent icon;
	private JLabel Name, Descr,RealDescr, Size;
	private JPanel TextPanel;
	private double IconWidth = 0.2, HeaderHeight = 0.25,DescrHeight = 0.3,SizeHeight = 0.45;
	@SuppressWarnings("unused")
	private int LeftWidth; 
	public SPrj_ListElement_Widget (String name,String descr,int IDgroup,int size)
	{
		...
		RealDescr = new JLabel(descr);RealDescr.setPreferredSize(new Dimension((int)TextPanel.getPreferredSize().getWidth(),(int)(TextPanel.getPreferredSize().getHeight()*DescrHeight)));
		RealDescr.setFont(new Font("Helvetica",Font.PLAIN,12));
		RealDescr.setForeground(new Color(180,180,195));
		RealDescr.setBackground(new Color(200,200,50));
		RealDescr.setHorizontalAlignment(SwingConstants.LEFT);
		...
		TextPanel.add(Name);TextPanel.add(Descr);TextPanel.add(RealDescr);TextPanel.add(Size);
